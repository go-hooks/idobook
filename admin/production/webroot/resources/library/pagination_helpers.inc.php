 ...
 * Recibe el par�metro group, donde se especifica el m�ximo de botones en grupo

 * en el array de opciones se puede establecer bootstrap-false, al darlo de alta

 * el paginador omitir� las clases de bootrap.
...
function paginate_helper($group = 5, $options = array()) {
    ...
    // Si hay mas paginas a la izquierda antes del l�mite a mostrer, imprime bot�n de retorno r�pido
    ...
    // Imprime p�ginas a la izquierda
    ...
    while (($start <= $pagination['pages']) && $positions > 0) {
        ...
        // Predice si habr� FF para reducir un espacio
...
// no se especifica devuelve como resultado la dirección:
