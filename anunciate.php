    ...
    <div class="banners">
        <table width="550">
            <tr>
                ...
                <td>$1,800.00 Por 30 Días<td>
                
            </tr>
            <tr>
                <td><h2 class="colorazul">Banner 2</h2><td>
                <td>$1,400.00 Por 30 Días<td>
            ...
            <tr>
                ...
                <td>$1,200.00 Por 30 Días<td>
                <!--<td><input type="button" class="btnregistro" value="COMPRAR"><td>-->
            </tr>
            <tr>
                <td><h2 class="colorazul">Banner 5</h2><td>
                <td>$700.00 Por 30 Días<td>
                <!--<td><input type="button" class="btnregistro" value="COMPRAR"><td>-->
            </tr>
            
            <tr>                
                <td>Precios más IVA <strong>Pregunta por nuestros paquetes por &nbsp; 7 o 15</strong><td>
