...
<section class="wrapper">
    ...
    <div class="registro">
        <h2>EDITAR MINISITIO PROVEEDOR<br>            
    ...
    <div class="registro">
        <p class="radios">TIPO SUBSCRIPCIÓN 
            <input type="radio" value="1" name="subscripcion" <?php if($proveedor['subscripcion']=='1') echo 'checked=""' ?> > 1 AÑO  
            <input type="radio" value="2" name="subscripcion" <?php if($proveedor['subscripcion']=='2') echo 'checked=""' ?>> 2 AÑOS
            <input type="radio" value="3" name="subscripcion" <?php if($proveedor['subscripcion']=='3') echo 'checked=""' ?>> 3 AÑOS
        </p>


        <p class="radios">SELECCIONA TU FORMA DE PAGO
            <input type="radio" value="TRANSFERENCIA" name="forma_de_pago" <?php if($proveedor['forma_de_pago']=='TRANSFERENCIA') echo 'checked=""' ?>> TRANSEFERENCIA BANCARIA
            <input type="radio" value="EFECTIVO" name="forma_de_pago" <?php if($proveedor['forma_de_pago']=='EFECTIVO') echo 'checked=""' ?>> EFECTIVO
        </p>
