...
<section class="wrapper">
    ...
    <div>
        <h3>1.	¿Qué es tumedicolaguna.com?</h3>
        ...
        <h3>2.	¿Qué clase de información se puede encontrar en tumedicolaguna.com?</h3>
        <p>En tumedicolaguna podrás encontrar información de Instituciones Médicas como Clínicas, Hospitales, Laboratorios, Farmacias, Profesionales Médicos, Especialistas en Medicina Alternativa, Aseguradoras, Proveedores de Equipo y Mobiliario Médico, Restaurantes de alimentos saludables, Gimnasios, Spas, etc.</p>
        ...
        <p>Para generar una solicitud de un banner publicitario, tienes que dar clicen la opción de "Anúnciate con Nosotros", donde te mostraremos las opciones e información de costos; una vez que estés seguros de generar una solicitud, tienes que dar clic en el botón COMPRAR y el sistema te redireccionará a un formulario de contacto que tendrás que llenar para completar el proceso de solicitud, una vez enviada, un agente de ventas se pondrá en contacto contigo a la brevedad.O puedes simplemente enviarnos un correo a <b><a href="mailto:ventas@tumedicolaguna.com">ventas@tumedicolaguna.com</a></b></p>
