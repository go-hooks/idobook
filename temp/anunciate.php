...
<section class="wrapper">
    ...
    <h3>Anúnciate<br><span>Conoce nuestros paquetes promocianales</h3>

    <div class="banners">
        <table width="550">
            <tr>
                <td><h2 class="colorazul">Banner 1</h2><td>
                <td>$3,600.00 Mensual<td>
                <td><input type="button" class="btnregistro" value="COMPRAR"><td>
            </tr>
            <tr>
                <td><h2 class="colorazul">Banner 2</h2><td>
                <td>$2,800.00 Mensual<td>
                <td><input type="button" class="btnregistro" value="COMPRAR"><td>
            </tr>
            <tr>
                <td><h2 class="colorazul">Banner 3</h2><td>
                <td>$2,000.00 Mensual<td>
                <td><input type="button" class="btnregistro" value="COMPRAR"><td>
            </tr>
            <tr>
                <td><h2 class="colorazul">Banner 4</h2><td>
                <td>$1,600.00 Mensual<td>
                <td><input type="button" class="btnregistro" value="COMPRAR"><td>
            </tr>
            <tr>
                <td><h2 class="colorazul">Banner 5</h2><td>
                <td>$900.00 Mensual<td>
                <td><input type="button" class="btnregistro" value="COMPRAR"><td>
            </tr>
        </table>
    </div>

    <p><span class="colorazul">Banner 1</span> (960 X 220) </p>
    <img src="img/banner1.png">
    <p><span class="colorazul">Banner 2</span> (960 X 130) </p>
